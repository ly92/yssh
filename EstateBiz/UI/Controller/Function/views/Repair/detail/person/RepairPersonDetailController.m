...
- (IBAction)submit:(id)sender{
    ...
    [[BaseNetConfig shareInstance]configGlobalAPI:WETOWN];
    ApplyRepairAPI *applyRepairApi = [[ApplyRepairAPI alloc]initWithCommunityid:communityid unit:self.lblUnit.text maintype:self.maintype subtype:subtypeid content:self.txtContent.text username:self.lblName.text mobile:self.lblMobile.text address:self.txtAddress.text image:self.uploadImg.image];
