...
static MLBlackTransitionGestureRecognizerType __MLBlackTransitionGestureRecognizerType = MLBlackTransitionGestureRecognizerTypeScreenEdgePan;
...
+ (void)validatePanPackWithMLBlackTransitionGestureRecognizerType:(MLBlackTransitionGestureRecognizerType)type class:(Class)clazz
{
    ...
    dispatch_once(&onceToken, ^{
		...
		__MLBlackTransition_Swizzle(clazz, @selector(viewDidLoad),@selector(__MLBlackTransition_Hook_ViewDidLoad));
    });
}
